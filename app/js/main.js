...
(function() {
    ...
    app.directive('leftSideContainer', function() {
        return {
            restrict: 'C',
            transclude: true,
            template: '<div class="col-md-9 slide-top" ng-if="itemone" ng-transclude></div>'
    ...
    app.directive('rightSideContainer', function() {
        return {
            restrict: 'C',
            transclude: true,
            template: '<div class="col-md-3 slide-top" ng-if="itemtwo" ng-transclude></div>'
    ...
    app.controller('personalWebsiteAppController', ['$scope', '$rootScope', '$timeout', '$location', '$anchorScroll', '$http', '$sce', function($scope, $rootScope, $timeout, $location, $anchorScroll, $http, $sce) {
        ...
        $scope.closeMenu = function() {
            ...
            topNav.addClass('closedMenu')
            topNav.removeClass('openedMenu')
        }
        ...
        var topNav = angular.element(document.querySelector('.top-nav'));
        $scope.openMenu = function() {
            leftSide.addClass('openMobileMenu')
            leftSide.removeClass('closeMobileMenu')
            topNav.addClass('openedMenu')
            topNav.removeClass('closedMenu')
        }
